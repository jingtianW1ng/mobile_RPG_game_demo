...
public class BossScreen implements Screen {
    ...
    public BossScreen(MyGdxGame game) {this.game = game;}
    public void create() {
        ...
        tiledMap = new TmxMapLoader().load("Background/levelThree.tmx");
        ...
        backgroundMusic = Gdx.audio.newMusic(Gdx.files.internal("levelThree.wav"));
    ...
    private void newGame() {
        ...
        player.characterX = 150;
        player.characterY = 40;
