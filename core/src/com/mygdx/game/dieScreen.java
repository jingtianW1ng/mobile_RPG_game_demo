...
public class dieScreen implements Screen{
    ...
    public dieScreen(MyGdxGame game) {
        this.game = game;


    }
    public void create() {
        Gdx.app.log("dieScreen: ","diescreen create");
        ...
        background = new Texture("Background/dieBackground.png");
    ...
    public void render(float f) {
        ...
        font.draw(batch, "YOU DIED", Gdx.graphics.getWidth()/2-175, Gdx.graphics.getHeight()/2+350);
